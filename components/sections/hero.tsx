...
export function Hero() {
  return (
    <section className="dark relative isolate flex min-h-[85svh] overflow-hidden bg-background pt-[4.5rem] text-foreground">
      <div
        aria-hidden="true"
        ...
        <div className="grid gap-8 border-t border-border py-7 md:grid-cols-[minmax(0,44rem)_auto] md:items-end md:py-8">
          <div>
            <p className="max-w-2xl text-base leading-7 text-foreground/82 sm:text-lg sm:leading-8">
              Product-minded software engineer working across backend systems,
              AI workflows, APIs, data infrastructure, reliability, and
              performance.
            </p>
