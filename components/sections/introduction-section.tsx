...
export function IntroductionSection() {
  return (
    <section
      ...
      className="bg-background px-5 py-24 text-foreground sm:px-8 lg:py-28"
    >
      <div className="mx-auto grid w-full max-w-[97.5rem] items-start gap-10 lg:grid-cols-[11.25rem_minmax(0,1fr)] lg:gap-14">
        <Avatar
          aria-label="Arpit Singhal"
        ...
        <div className="space-y-7">
          ...
          <div className="grid max-w-[62.5rem] gap-7 text-[0.9375rem] leading-[1.65] text-muted-foreground sm:grid-cols-2">
            <p>
